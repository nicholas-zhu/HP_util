function [estimates, fitted, rss, rmse] = expfitw(xdata, ydata, start_point, weight)
...
%   weight = weighting on lsqr problem
%
% Outputs:
...
% plot the FittedCurve at the end.
    function [Error, FittedCurve] = expfun(params)
        ...
        ErrorVector = weight.*(FittedCurve - ydata);
